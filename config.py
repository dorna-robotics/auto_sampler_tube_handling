...
decapper = {
    "aux": [435-7.5, 0],
    "frame": [35*25+12.5-23.5-7.5, -(10*25+12.5), 0, 180, 0, 0],
...
cap_holder = {
    ...
    "pick": [0.5286622981476512, 3.5193017123831964, -10.858378489849372+10, -4.769162562411459e-16, 2.572475798769063e-15, -42.011718],
...
camera = {
    ...
    "joints_vials": [-72.817383, 1.867676, -120.498047, 0.021973, 28.608398, -72.817383], #New
    "joints_caps": [-37.792969, 6.152344, -110.830078, 0.043945, 14.655762, -74.86084],
...
take_init_picture = {
    "pick": {
        "type": "joint", # robot, world, joint
        "loc": [camera["joints_vials"], camera["aux"]]
    },
    "base_in_world": robot["base_in_world"],
    "aux_dir": robot["aux_dir"],
    "sleep": sleep, 
